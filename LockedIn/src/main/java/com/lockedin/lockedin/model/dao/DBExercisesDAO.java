...
public class DBExercisesDAO {
    ...
    /**
     * Initializes the DAO by connecting to the exercises database, creating the table if needed,
    ...
    /**
     * Creates the exercises table if it does not already exist. Stores exercise metadata such as
    ...
    public void addExercise(Exercise exercise) {
        String sql =
                "INSERT INTO exercises (name, instruction, category, primary_muscle,"
    ...
    public Exercise getExerciseById(int id) {
        String sql =
                "SELECT id, name, instruction, category, primary_muscle, exercise_image_url FROM"
                        + " exercises WHERE id = ?";
