...
// ---- authenticate() tests require Authentication.authenticate(email, password, UserDAO)
// overload — does not exist yet. These tests will fail to compile until GREEN phase.
